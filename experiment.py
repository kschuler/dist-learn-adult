...
EXP_INFO = {
	...
	'condition': ['1', '2']   	# list of possible conditions (user selects one or the other)
}
...
class DistLearnExperiment(object):
    ...
    def runExperiment(self):
        ...
        self.exposure(phase = 'test', condfile = EXP_INFO['condition']+'-exposure.csv', reps = 1)
    ...
    def expPhase(self, phase = 'exposure', condfile = None, reps = 1):
		# change back to exposure and test
